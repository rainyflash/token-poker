...
pub const CONTROL_PROTOCOL: &str = "/token-holdem/control/9";
pub const TABLE_POOL_TOPIC_PREFIX: &str = "/token-holdem/table-pool/1/";
pub const TABLE_SESSION_TOPIC_PREFIX: &str = "/token-holdem/table-session/1/";
pub const FRIEND_ROOM_TOPIC_PREFIX: &str = "/token-holdem/friend-room/1/";
pub const PROTOCOL_VERSION: &str = "9";
pub const IDENTIFY_PROTOCOL: &str = "/token-holdem/9.0.0";
